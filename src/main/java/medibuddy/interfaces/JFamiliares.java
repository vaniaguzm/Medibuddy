...
private void inicializarDatosPrueba() {
            ...
            if (fam != null) {
                ...
                if (cnbAdulto.getSelectedIndex() > 0) {
                    ...
                    if (cnbMedicamento.getSelectedIndex() > 0) {
                        ...
                        adultoActual.agregarMedicamento(nuevoMed);
                        adultoService.actualizarAdultoMayor(adultoActual);
                    }
                }
    ...
    private boolean yaTieneMedicamento(AdultoMayor adulto, String nombreMed, String dosis) {
        for (Medicamento m : adulto.getMedicamentos()) {
            if (m.getNomMedicamento().equalsIgnoreCase(nombreMed) && 
                m.getDosis().equalsIgnoreCase(dosis)) { 
